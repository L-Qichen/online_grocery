...
if (isset($_POST['add'])){
    ...
    if(isset($_SESSION['cart'])){
        ...
        if(in_array($_POST['product_id'], $item_array_id)){
            ...
            echo "<script>window.location = 'p3cucumber.php'</script>";
        }else{
...
<body>
    <div id="box">
        ...
        <?php
                ...
                colaElement ("8874246668318.jpg", "Cucumber", "2.49", "15");
        ?>
                    ...
                    <script>
                        function Falue() {
                            var total = parseInt(qnt_1.value) * 15.85;
...
function myFunction()
{
    var text="Origin : Belgium, Canada, Spain, United States, Honduras, Morocco, Mexico, Netherlands, Dominican Republic";
