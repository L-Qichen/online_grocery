...
if (isset($_POST['add'])){
    ...
    if(isset($_SESSION['cart'])){
        ...
        if(in_array($_POST['product_id'], $item_array_id)){
            ...
            echo "<script>window.location = 'p3tomato.php'</script>";
        }else{
...
<body>
    <div id="box">
        ...
        <?php
                ...
                colaElement ("9355073552414.jpg", "Tomato", "2.20", "13");
        ?>
                    ...
                    <script>
                        function Falue() {
                            var total = parseInt(qnt_1.value) * 32.85;
