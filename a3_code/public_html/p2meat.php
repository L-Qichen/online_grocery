...
if (isset($_POST['add'])){
    ...
    if(isset($_SESSION['cart'])){
        ...
        if(in_array($_POST['product_id'], $item_array_id)){
            ...
            echo "<script>window.location = 'p2meat.php'</script>";
        }else{
	...
	<div id="box">
		...
		<div class="leftbar">
            ...
            <div class="grid-container ">
                <?php
                          component("Pork","1.99","pork.png","7","p3pork.php");
                          component("Beef", "45.23","beef.png","8","p3beef.php");
                          component("Lamb","33.22","lamb.png","9","p3lamb.php");
                          component("Duck","2.99","duck.png","10","p3duck.php");
                          component("Chickenbreast","1.99","chickenbreast.png","11","p3chickenbreast.php");
                          component("chicken legs","4.99","chickenDrumsticks.png","12","p3chickenlegs.php");
