...
if (isset($_POST['add'])){
    ...
    if(isset($_SESSION['cart'])){
        ...
        if(in_array($_POST['product_id'], $item_array_id)){
            ...
            echo "<script>window.location = 'p3lettuce.php'</script>";
        }else{
...
<body>
    <div id="box">
        ...
        <?php
                ...
                colaElement ("8837225676830.jpg", "Green Leaf Lettuce", "1.29", "18");
        ?>
...
function myFunction()
{
    var text="Origin : Canada, Spain, United States, Mexico";
