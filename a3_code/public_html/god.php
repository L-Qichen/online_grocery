...
<body>
    <div id="box">
                ...
                <div class="topcon main clearfix">
                    ...
                    <div class="topright fr">
                        <ul class="rightTxt reset">
                            ...
                            <li><a href="P4.html"><i class="material-icons">shopping_cart</i>My Cart</a></li>
        ...
        <div class="procedure main clearfix">
            ...
            <a href="b2be.php"><span>/ Beverages </span></a>
        </div>
...
colaElement ("god ridge.jpg", "god ridge", "1.99", "5");
?>

    <script>
        function Falue() {
            var total = parseInt(qnt_1.value) * 1.99;
