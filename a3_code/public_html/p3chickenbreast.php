...
if (isset($_POST['add'])){
    ...
    if(isset($_SESSION['cart'])){
        ...
        if(in_array($_POST['product_id'], $item_array_id)){
            ...
            echo "<script>window.location = 'p3chickenbreast.php'</script>";
        }else{
...
<body>
    <div id="box">
        ...
        <?php
                ...
                colaElement ("chickenbreastb.png", "Chickenbreast", "22", "11");
        ?>
                    ...
                    <script>
                        function Falue() {
                            var total = parseInt(qnt_1.value) * 22;
